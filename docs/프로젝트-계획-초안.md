...
| **테스트 생성** | SQL 통합 테스트 초안 생성과 사람 검수; tSQLt는 SQL MI CLR 공식 호환성 확인 후 도입 검토 | 테스트 백로그 감소 |
...
| **Phase 2 — P1 실무 확장** | 2주 | 빌드 엄격도, shard 카나리/fan-out, 인스턴스 오브젝트, PITR/롤백 런북 |
| **Phase 3 — P2 품질과 운영** | 2~3주 | AI 청크 리뷰, 데이터 무결성 테스트, 읽기 전용 정기 drift report |
| **Phase 4 — AI 고도화** | 2~3주 | 품질 지표 기반 blocking gate, 테스트 생성 보조, 운영 이상 분석 |
